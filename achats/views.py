...
#         # Récupérer tous les achats du client
#                 # Récupérer tous les achats du client
#         achats_client = Achat.objects.filter(ClientID_id=client_id).order_by('-Achat_date')
#         achats_serializer = AchatReadSerializer(achats_client, many=True)
